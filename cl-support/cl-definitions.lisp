...
#+(or cmu allegro akcl lispworks ccl sbcl)
(define-mumble-macro mumble::funcall (fn . args)
...
#-(or lucid cmu allegro akcl ccl lispworks wcl sbcl)
...
#+(or cmu akcl ccl lispworks wcl sbcl)
...
#-(or cmu lucid allegro akcl ccl lispworks sbcl wcl)
...
#-(or cmu lucid allegro akcl ccl lispworks wcl sbcl)
...
#+(or cmu allegro ccl lispworks sbcl)
(define-mumble-import gensym)

#-(or lucid akcl wcl cmu allegro ccl lispworks sbcl)
...
#+(or cmu ccl allegro lispworks sbcl)
...
#-(or lucid allegro cmu akcl ccl lispworks wcl sbcl)
...
(defun code-quality-hack (q)
  (cond ((eql q 0)
	 (proclaim '(optimize (speed 1) (safety 3) (compilation-speed 3)
			      #+cmu (ext:debug 1)  
                              #+(or ccl allegro lispworks) (debug 1)
			      )))
	((eql q 1)
	 (proclaim '(optimize (speed 1) (safety 3) (compilation-speed 3)
			      #+cmu (ext:debug 1)
	...
	((eql q 2)
	 (proclaim '(optimize (speed 1) (safety 3) (compilation-speed 3)
			      #+cmu (ext:debug 0)
                              #+(or ccl allegro lispworks) (debug 0)
			      )))
	((eql q 3)
	 (proclaim '(optimize (speed 1) (safety 3) (compilation-speed 3)
			      #+cmu (ext:debug 0)
...
(progn
  (mumble::predefine (mumble::getenv string))
  (define-mumble-synonym mumble::getenv sb-unix::posix-getenv))
#+cmu
...
#+akcl
(define-mumble-synonym mumble::exit si:bye)
