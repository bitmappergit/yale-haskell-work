...
(defvar *lisp-binary-file-type*
  #+lucid (namestring (make-pathname :type (car lcl:*load-binary-pathname-types*)))
  #+allegro (concatenate 'string "." excl:*fasl-default-type*)
  ...
  #+ccl ".dx64fsl"
  #+sbcl ".fasl"
  #-(or lucid allegro cmu akcl mcl lispworks wcl sbcl ccl)
